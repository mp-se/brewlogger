...
pytestmark = pytest.mark.skip(reason="Requires full database and service setup")
...
async def test_fermentation_controller_step_active_temp_match():
    ...
    with patch("api.fermentationcontrol.DeviceService") as mock_service_class, \
         ...
         patch("api.fermentationcontrol.system_log_fermentationcontrol"):
...
async def test_fermentation_controller_step_active_temp_mismatch():
    ...
    with patch("api.fermentationcontrol.DeviceService") as mock_service_class, \
         patch("api.fermentationcontrol.chamberctrl_temps") as mock_temps, \
         patch("api.fermentationcontrol.chamberctrl_set_mode") as mock_set_temp, \
        ...
        mock_temps.assert_called_once_with(1, "http://localhost:8080")
        mock_set_temp.assert_called_once_with(1, "http://localhost:8080", 20.0, "ABC123", "fridge")
        ...
        temp_change_msg = "Expected temp change log"
        assert any("20.0" in arg and "18.0" in arg for arg in call_args), temp_change_msg
