...
#
"""Tests for fermentation prediction with real data."""
...
# Ensure app path is available for relative imports
...
def test_prediction_with_real_data():
    ...
    # { "og": 1.047..., "fg": 1.008,
    #   "measurements": [{ "created": "...", "gravity": ..., "temperature": ... }] }
    ...
    if len(points_48h) >= 2:
        ...
        history_window = [
            p for p in points_48h
            if (current[0] - p[0]).total_seconds() / 3600 <= 24.0
        ]
