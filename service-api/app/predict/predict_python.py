...
class BrewloggerPredictor:
    ...
    def __init__(self, model_path=None, scaler_path=None, metadata_path=None):
        ...
        self.model_path = (
            model_path or app_root / 'predict' / 'fermentation_model_ground_truth.pkl'
        )
        self.scaler_path = (
            scaler_path or app_root / 'predict' / 'scaler_ground_truth.pkl'
        )
        self.metadata_path = (
            metadata_path or app_root / 'predict' / 'model_metadata_ground_truth.json'
        )
    ...
    def calculate_features(  # pylint: disable=too-many-arguments,too-many-locals,too-many-positional-arguments
        ...
        # ['gravity_drop', 'gravity_drop_rate', 'drop_velocity_6h',
        #  'temp_velocity_6h', 'temp_corrected_rate', 'fermentation_progress'])
